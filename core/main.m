...
initial_Theta3 = randInitializeWeights(hidden_layer2_size, num_outputs);
...
[J, grad] = nnCostFunction(nn_params, input_layer_size, hidden_layer1_size, ...
            hidden_layer2_size, num_outputs, Xtrain, ytrain, lambda);
...
save result.mat Theta1 Theta2 Theta3 mu_ax sigma_ax mu_ay sigma_ay mu_az sigma_az ...
